...
**⚜ 𝙻𝚎𝚐𝚎𝚗𝚍𝚊𝚛𝚢 𝙰𝚏 𝙻𝚎𝚐𝚎𝚗𝚍𝙱𝚘𝚝 ⚜**
  •        [♥️ 𝚁𝚎𝚙𝚘 ♥️](https://github.com/LEGEND-AI/Cyberbot)
  •        [♦️ Deploy ♦️](https://dashboard.heroku.com/new?button-url=https%3A%2F%2Fgithub.com%2FLEGEND-AI%2FCyberbot&template=https%3A%2F%2Fgithub.com%2FLEGEND-AI%2FCyberbot)
  •  ©️ {Legend_channel} ™
"""
...
@legend.legend_cmd(
    ...
    info={
        "header": "Source code link of Cyberbot",
        "usage": [
            "{tr}repo",
        ],
    },
...
@legend.legend_cmd(
    ...
    info={
        ...
        "description": "It uploads the given file to your github repo in **Cyberbot/plugins** folder\
...
async def download(event):
    ...
    if Config.GIT_REPO_NAME is None:
        return await eod(
            event, "`Please ADD Proper Github Repo Name of your Cyberbot`", 5
        )
...
async def git_commit(file_name, mone):
    ...
    if create_file:
        file_name = f"Cyberbot/plugins/{file_name}"
        LOGS.info(file_name)
        try:
            repo.create_file(
            ...
            ccess = ccess.strip()
            await mone.edit(
                f"`Commited On Your Github Repo`\n\n[Your PLUGINS](https://github.com/{ccess}/tree/master/Cyberbot/plugins/)"
            )
