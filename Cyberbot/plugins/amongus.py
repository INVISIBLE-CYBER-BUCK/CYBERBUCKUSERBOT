...
async def amongus_gen(text: str, clr: int) -> str:
    url = "https://github.com/ITS-Cyberbot/RESOURCES/raw/master/Resources/Amongus/"
    font = ImageFont.truetype(
        BytesIO(
            get(
                "https://github.com/ITS-Cyberbot/RESOURCES/raw/master/Resources/fonts/bold.ttf"
            ).content
        ),
        60,
    )
...
async def get_imposter_img(text: str) -> str:
    background = get(
        f"https://github.com/ITS-Cyberbot/RESOURCES/raw/master/Resources/imposter/impostor{randint(1,22)}.png"
    ).content
    font = get(
        "https://github.com/ITS-Cyberbot/RESOURCES/raw/master/Resources/fonts/roboto_regular.ttf"
    ).content
    font = BytesIO(font)
