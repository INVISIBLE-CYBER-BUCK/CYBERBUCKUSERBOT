...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}fakegs Legenduserbot ; One of the Popular Cyberbot",
    },
)
...
@legend.legend_cmd(
    ...
    info={
        ...
        "usage": "{tr}trump <text>",
        "examples": "{tr}trump Legenduserbot is One of the Popular Cyberbot",
    },
)
async def nekobot(lol):
...
@legend.legend_cmd(
    ...
    info={
        ...
        "usage": "{tr}modi <text>",
        "examples": "{tr}modi Legenduserbot is One of the Popular Cyberbot",
    },
)
async def nekobot(lol):
...
@legend.legend_cmd(
    ...
    info={
        ...
        "usage": "{tr}cmm <text>",
        "examples": "{tr}cmm Legenduserbot is One of the Popular Cyberbot",
    },
)
async def nekobot(lol):
    text = lol.pattern_match.group(1)
...
@legend.legend_cmd(
    ...
    info={
        ...
        "usage": "{tr}kanna text",
        "examples": "{tr}kanna Legenduserbot is One of the Popular Cyberbot",
    },
)
async def nekobot(lol):
...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; Legenduserbot is One of the Popular Cyberbot",
    },
)
async def nekobot(lol):
