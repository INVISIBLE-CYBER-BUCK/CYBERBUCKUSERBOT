...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}weeb LegendUserBot",
    },
)
...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}downside LegendUserBot",
    },
)
...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}subscript LegendUserBot",
    },
)
async def stylish_generator(event):
...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}superscript LegendUserBot",
    },
)
async def stylish_generator(event):
