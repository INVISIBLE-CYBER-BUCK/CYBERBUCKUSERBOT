...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}cbutton test [google]<buttonurl:https://www.google.com> [LegendUserBot]<buttonurl:https://t.me/Cyberbot_OP17:same> [support]<buttonurl:https://t.me/Cyberbot_AI>",
    },
)
async def _(event):
...
@legend.legend_cmd(
    ...
    info={
        ...
        "examples": "{tr}ibutton test <media:downloads/thumb_image.jpg> [google]<buttonurl:https://www.google.com> [Cyberbot]<buttonurl:https://t.me/Cyberbot_AI:same> [support]<buttonurl:https://t.me/Cyberbot_op>",
    },
)
async def _(event):
