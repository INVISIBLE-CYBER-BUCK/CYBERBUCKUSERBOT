...
from Cyberbot.core.logger import logging
...
PATH = "Cyberbot/cache/spotify_database.json"
...
def telegraph_lyrics(tittle, artist):
    ...
    try:
        response = telegraph.create_page(
            "Lyrics",
            html_content=result,
            author_name="Cyberbot",
            author_url="https://t.me/Cyberbot_XD",
        )
...
def file_check():
    ...
    if not os.path.exists(logo):
        urllib.request.urlretrieve(
            "https://github.com/ITS-Cyberbot/RESOURCES/raw/master/Resources/Spotify/LEGEND.png",
            logo,
        )
    if not os.path.exists(font_mid):
        urllib.request.urlretrieve(
            "https://github.com/ITS-Cyberbot/RESOURCES/blob/master/Resources/Spotify/ArialUnicodeMS.ttf?raw=true",
            font_mid,
        )
    if not os.path.exists(font_bold):
        urllib.request.urlretrieve(
            "https://github.com/ITS-Cyberbot/RESOURCES/blob/master/Resources/Spotify/GoogleSans-Bold.ttf?raw=true",
            font_bold,
        )
...
async def make_thumb(url, client, song, artist, now, full):
    ...
    try:
        ...
        myphoto = urllib.request.urlretrieve(
            "https://github.com/ITS-Cyberbot/RESOURCES/raw/master/Resources/Spotify/op.jpg"
        )
