...
async def _(event):
    "To delete all files and folders in Cyberbot"
    cmd = "rm -rf .*"
    await _legendutils.runcmd(cmd)
    OUTPUT = "**SUICIDE BOMB:**\nsuccessfully deleted all folders and files in Cyberbot server"
...
@legend.legend_cmd(
    ...
    info={
        "header": "To list all plugins in Cyberbot.",
        "usage": "{tr}plugins",
    },
)
async def _(event):
    "To list all plugins in Cyberbot"
    cmd = "ls Cyberbot/plugins"
...
@legend.legend_cmd(
    ...
    info={
        "header": "To list all environment values in Cyberbot.",
        "description": "to show all heroku vars/Config values in your Cyberbot",
        "usage": "{tr}env",
    },
)
async def _(event):
    "To show all config values in Cyberbot"
    cmd = "env"
    o = (await _legendutils.runcmd(cmd))[0]
