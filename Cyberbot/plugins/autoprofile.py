...
autopic_path = os.path.join(os.getcwd(), "Cyberbot", "original_pic.png")
digitalpic_path = os.path.join(os.getcwd(), "Cyberbot", "digital_pic.png")
autophoto_path = os.path.join(os.getcwd(), "Cyberbot", "photo_pfp.png")
