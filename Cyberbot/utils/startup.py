...
from Cyberbot import BOTLOG, BOTLOG_CHATID, PM_LOGGER_GROUP_ID, legendversion
...
async def load_plugins(folder, extfolder=None):
    ...
    if extfolder:
        ...
        path = f"Cyberbot/{folder}/*.py"
        plugin_path = f"Cyberbot/{folder}"
...
async def verifyLoggerGroup():
    ...
    if BOTLOG:
        ...
        descript = "A Logger Group For Cyberbot.Don't delete this group or change to group(If you change group all your previous snips, welcome will be lost.)"
        _, groupid = await create_supergroup(
            "Cyberbot Logger", legend, Config.BOT_USERNAME, descript
        )
...
async def install_extrarepo(repo, branch, efolder):
    ...
    await load_plugins(folder="Cyberbot", extfolder=efolder)
