...
from Cyberbot import Config, legend
    ...
    if chat.id != Config.OWNER_ID:
        ...
        if customstrmsg is not None:
            buttons = [
                ...
                (Button.url("🔱 Support 🔱", "https://t.me/Cyberbot_OP"),),
            ]
            ...
            start_msg = f"Hey! 👤{mention},\nI am {my_mention}'s assistant bot.\nYou can contact to my master from here.\n\nPowered by [Cyberbot](https://t.me/Cyberbot_OP)"
            buttons = [
                (
                    Button.inline("🔰 Rules 🔰", data="rules"),
                    Button.inline("❤ Deploy ❤", data="depy"),
        ...
        buttons = [
            (
                Button.url(" Support ", "https://t.me/Cyberbot_OP"),
                Button.url(" Updates ", "https://t.me/Cyberbot_AI"),
            ),
            (
...
async def help(event):
    if event.query.user_id == bot.uid:
        ...
        await event.client.send_message(
            event.chat_id,
            message="You Can Deploy/Install Cyberbot In Heroku By Following Steps Bellow, You Can See Some Quick Guides On Support Channel Or On Your Own Assistant Bot. \nThank You For Contacting Me.",
            link_preview=False,
            buttons=[
                [
                ...
                [
                    Button.url(
                        "Github Repo ❓", "https://github.com/LEGEND-AI/Cyberbot"
                    ),
                ],
            ],
        )
