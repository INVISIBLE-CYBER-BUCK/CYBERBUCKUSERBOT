...
from Cyberbot import Config, legend, legendversion
...
pm_caption += f"┣Çhâññel ~ [Channel](https://t.me/Cyberbot_AI)\n"
pm_caption += f"┣**License** ~ [License v3.0](github.com/LEGEND-AI/LEGENBOT/blob/master/LICENSE)\n"
pm_caption += f"┣Copyright ~ By [『Lêɠêɳ̃dẞø†』 ](https://t.me/Cyberbot_OP)\n"
pm_caption += f"┣Assistant ~ By [『Lêɠêɳ̃dẞøy』 ](https://t.me/LegendBoy_XD)\n"
pm_caption += f"╰────────────\n"
pm_caption += f"       »»» [『Lêɠêɳ̃dẞø†』](https://t.me/Cyberbot_XD) «««"
...
async def bot_start(event):
    ...
    buttons = [
        (Button.url("🔱 Repo 🔱", "https://github.com/LEGEND-AI/Cyberbot"),),
    ]
    try:
